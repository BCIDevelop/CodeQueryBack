    ...
    signUp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield mail_provider_1.default.send(email, "Please confirm you account", `Confirm you account : <button> <a href='${client_url}/confirm?email=${email}&token=${token}'>Confirm account</a> </button>`);
